...
**Note: Lightstreams' team is intensely working on a version to optimize the security and performance of our Test Network. Soon we will announce our progress in our [Blog](https://medium.com/lightstreams), if you have any questions we are working in providing prompt feedback through our [Forum](https://discuss.lightstreams.network/)**
